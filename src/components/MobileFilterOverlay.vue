<template>
  <div class="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-end lg:hidden">
    <div class="bg-base-100 w-full h-[90%] rounded-t-3xl shadow-2xl flex flex-col">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-2">
              <button class="btn btn-sm" :class="localFilters.transmission === 'Automatic' ? 'btn-primary' : 'btn-outline'" @click="toggleTransmission('Automatic')">Automatisk</button>
              <button class="btn btn-sm" :class="localFilters.transmission === 'Manual' ? 'btn-primary' : 'btn-outline'" @click="toggleTransmission('Manual')">Manual</button>
            </div>
          </div>
