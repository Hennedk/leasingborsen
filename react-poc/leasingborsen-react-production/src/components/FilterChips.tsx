          ...
          {activeFilters.map((filter) => {
            ...
            return (
              ...
              >
                <Badge 
                  variant="secondary" 
                  className="flex items-center gap-2 px-3 !py-0 bg-card/95 border border-border/50 hover:bg-muted/50 hover:border-primary/30 transition-all duration-200 whitespace-nowrap h-8"
                >
