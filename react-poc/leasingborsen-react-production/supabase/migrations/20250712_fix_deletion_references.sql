-- Fix the deletion logic in apply_selected_extraction_changes to handle multiple references better
    ...
    ELSIF change_record.change_type = 'delete' AND existing_listing_id IS NOT NULL THEN
      BEGIN
        ...
        WHERE existing_listing_id = change_record.existing_listing_id
          AND change_status IN ('pending', 'discarded'); -- Don't delete already applied/rejected changes
