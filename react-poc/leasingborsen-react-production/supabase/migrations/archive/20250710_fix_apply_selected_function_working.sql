-- Working version of apply_selected_extraction_changes function
-- Fixed: removed non-existent columns and simplified ON CONFLICT handling
...
COMMENT ON FUNCTION apply_selected_extraction_changes IS 'Apply selected changes from extraction session. Fixed: removed non-existent columns, removed ON CONFLICT clause, improved error handling.';