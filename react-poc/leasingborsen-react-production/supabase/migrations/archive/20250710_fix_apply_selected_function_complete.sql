-- Complete fix for apply_selected_extraction_changes function
-- Fixed: removed non-existent columns (colour, created_at/updated_at from lease_pricing)
...
COMMENT ON FUNCTION apply_selected_extraction_changes IS 'Apply selected changes from extraction session. Complete fix: removed all non-existent columns.';